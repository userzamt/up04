...
написать bash-скрипт по поиску имен пакетов в репозиториях. Необходимо найти и вывести на экран список все пакетов, хранящихся в репозиториях, имена которых начинаются на *mysql*. Скрипт должен выводить только названия пакетов. Имя каждого найденного пакета выводится на отдельной строке. Из всех найденных пакетов, при выводе на экран выделить другим цветом текста и фона пакет mysql-community-server.
