...
1. Используя VirtualBox/[VMware Workstation Pro](https://softwareupdate.vmware.com/cds/vmw-desktop/ws/17.5.2/23775571/) создать виртуальную машину и установить на неё операционную систему РЕД ОС 7
