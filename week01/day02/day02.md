...
1. Создать виртуальную машину и установить на неё операционную систему РЕД ОС 8(либо используя снимки состояния виртуальной машины восстановить её до исходного состояния)

1. Установить тип подключения сети виртуальной машины в значение *Виртуальный адаптер*. Написать bash-скрипт выводящий на экран текущий IP-адрес.
